...
<script type="text/javascript">
	function jpdetail(id){
		window.location.href = "/sale/index/tojpDetail?id="+id;
	}
</script>
</head>
<body>
	    ...
	    <!--SIDE NAV ENDS-->
            ...
            <div id="main_content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><a href="javascript:;">竞拍</a></li>
                </ul>
                <!--Product List Starts-->
                <div class="products_list products_slider">
                    <ul>
                    <c:forEach var="product" items="${jplist}" varStatus="status">
                        <li> <a href="javascript:jpdetail(${product.id });" class="product_image"><img src="/sale/${product.img}" style="width: 216px;height: 245px;" /></a>
                            <div class="product_info">
                                <h3><a href="javascript:jpdetail(${product.id });">${product.name }</a></h3>
                                <small>${product.content }</small> </div>
                                <!-- 
                            <div class="price_info"> <a href="javascript:addCart('${product.id }','${product.jpprice }');">+ 收藏</a>
                                <button class="price_add" title="" type="button"><span class="pr_price">￥${product.jpprice }</span><span class="pr_add">加入购物车</span></button>
                            </div>
                             -->
                        </li>
                    </c:forEach>
