                                        ...
                                        <form method="post" action="/sale/order/topay" id="login-form" />
                                            <fieldset>
                                                <ul class="form-list">
                                                    ...
                                                    <li>
                                                        <label class="required" for="login-password"><em>*</em>地址</label>
                                                        <div class="input-box">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="input-box">
                                                            	申通<input type="radio" checked="checked" name="senddept" value="申通" class="input-text" style="width: 20px;"/>&nbsp;&nbsp;
                                                            	圆通<input type="radio" name="senddept" value="圆通" class="input-text" style="width: 20px;"/>&nbsp;&nbsp;
                                                            	中国邮政<input type="radio" name="senddept" value="中国邮政" class="input-text" style="width: 20px;"/>&nbsp;&nbsp;
                                                        </div>
                                                    </li>
                                                </ul>
                                                <br />
                                ...
                                <div class="col2-set">
                                    ...
                                    <div class="col-2">
                                        <div class="buttons-set"> <a class="fl_right" href="#"></a>
                                            <button class="button brown_btn" onclick="topay();" type="button">确定</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
