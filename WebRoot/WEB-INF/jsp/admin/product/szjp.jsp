				...
				<table width="100%" height="100%" cellpadding="0" cellSpacing=0 border=0 borderColor="#ff0000">
					<tbody>
						<tr> 
							...
							<td valign="top">
								<div class="title"><h2>设置竞拍</h2></div>
								<div class="maincon">
								<form action="/sale/product/szjp" method="post">
									<table class="formtable" width="100%">
										<tr>
											<td width="180px" align="right">竞拍产品：</td>
											<td colspan="3">
												<div class="stext">${product.name}</div>
											</td>
										</tr>
										<tr>
											<td width="180px" align="right">起拍价格：</td>
											<td colspan="3">
												<div class="stext"><input type="text" name="price" value="" id="price" /></div>
											</td>
										</tr>
										<tr>
											<td width="180px" align="right">竞拍结束时间：</td>
											<td colspan="3">
												<div class="stext">
