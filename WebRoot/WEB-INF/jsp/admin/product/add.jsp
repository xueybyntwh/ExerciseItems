					...
					<tbody>
						<tr> 
							...
							<td valign="top">
								...
								<div class="maincon">
								<form action="/sale/product/add" target="hideWin" method="post" enctype='multipart/form-data'>
									<table class="formtable" width="100%">
										<tr>
											<td width="180px" align="right">商品名称：</td>
											<td colspan="3">
												<div class="stext"><input type="text" name="name" value="" id="name" /></div>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td colspan="3">
												<textarea id="content" name="content" style="width:500px;height:180px;" ></textarea>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td style="border:0;"><input type="submit" name="" value="提交" id="" class="btn-img" /></td>
										</tr>
									</table>
								</form>
								</div>						
